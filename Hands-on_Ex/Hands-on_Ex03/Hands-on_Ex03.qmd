...
The code chunk below `read.csv()` of **readr** package is used to import *Exam_data.csv* data file into R and save it as an tibble data frame called `exam_data`.
...
[ggiraph](https://davidgohel.github.io/ggiraph/index.html) ![](https://r4va.netlify.app/chap03/img/image1.jpg){width="41"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
![](https://r4va.netlify.app/chap03/img/image2.jpg){width="625"}
