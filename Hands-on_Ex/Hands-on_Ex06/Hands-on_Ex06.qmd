...
In this section, I learn how to plot a calender heatmap programmatically by using ggplot2 package.
...
First, I use the code chunk below to import *eventlog.csv* file into R environment and called the data frame as *attacks*.
